...
class TransactionMercanetSerializer(serializers.Serializer):
	...
	def create(self):
	    TransactionMercanet.Seal = sealTransaction(TransactionMercanet.amount, TransactionMercanet.currencyCode, TransactionMercanet.interfaceVersion, TransactionMercanet.keyVersion, TransactionMercanet.merchantId, TransactionMercanet.normalReturnUrl, TransactionMercanet.orderChannel, TransactionMercanet.transactionReference, secretKey)
	    return 
